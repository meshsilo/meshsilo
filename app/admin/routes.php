...
<div class="admin-content">
    ...
    <div class="settings-section">
        ...
        <div style="margin-bottom: 0.5rem;">
            <input type="search" id="route-filter" placeholder="Filter routes..." aria-label="Filter routes" enterkeyhint="search" style="width: 100%; max-width: 250px; padding: 0.3rem 0.5rem; font-size: 0.8rem; border-radius: 4px; border: 1px solid var(--color-border); background: var(--color-surface);">
        </div>
