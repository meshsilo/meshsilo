...
// deleteModelFile(), cleanupModelFiles(), safeUnlinkAssetFile() and
// deleteModelVersionFiles() now live in includes/helpers/model-delete.php
// (loaded via includes/db.php) so the REST API and mass/batch actions share
// the exact same cleanup logic.
